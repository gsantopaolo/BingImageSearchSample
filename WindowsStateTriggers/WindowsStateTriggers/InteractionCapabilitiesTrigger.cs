...
namespace WindowsStateTriggers
{
    ...
    /// 
    /// </summary>
    public class InteractionCapabilitiesTrigger : StateTriggerBase, ITriggerValue
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InteractionCapabilitiesTrigger"/> class.
        /// </summary>
        public InteractionCapabilitiesTrigger()
        {
            if (!Windows.ApplicationModel.DesignMode.DesignModeEnabled)
            {
                var weakEvent =
                    new WeakEventListener<InteractionCapabilitiesTrigger, object, WindowSizeChangedEventArgs>(this)
                    {
        ...
        public static readonly DependencyProperty InteractionModeProperty =
            DependencyProperty.Register("InteractionMode", typeof(InteractionCapability), typeof(InteractionCapabilitiesTrigger),
        ...
        {
            var obj = (InteractionCapabilitiesTrigger)d;
            if (!Windows.ApplicationModel.DesignMode.DesignModeEnabled)
            {
